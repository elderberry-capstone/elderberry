...
fc: fcfutils.o fcfmain.o module_testLoggerDisk.o module_testLoggerScreen.o module_mouse_clark.o module_mouse_clark2.o module_mouse_jm.o module_mouse_jm2.o module_profile.o module_gps.o module_theo-imu.o module_virtdev.o utils_sockets.o utils_libusb-1.0.o -lusb-1.0
